...
def get_order_family_target_np(targets):
    ...
    for i in range(targets.shape[0]):
        ...
        order_target_list.append(trees[targets[i]-1][1])
        family_target_list.append(trees[targets[i]-1][2])



    order_target_list = np.array(order_target_list)
    family_target_list = np.array(family_target_list) 

    return order_target_list, family_target_list

def get_order_family_target_count(targets):
    ...
    for i in range(targets.shape[0]):
        ...
        order_target_list.append(trees[targets[i]-1][1]-1)
        family_target_list.append(trees[targets[i]-1][2]-1)

...
def get_order_family_target_np(targets):
...
if __name__ == "__main__":
    num_superclass = max([i[1] for i in trees])
    num_fine = max([i[2] for i in trees])
    print(f"Number of order: {num_superclass}, Number of Family: {num_fine}")